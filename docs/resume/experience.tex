  ...
  \cventry
    ...
    {Oct. 2017 - PRESENT} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item{Build fully automated CI and CD pipelinelines for testing and application delivery using AWS EC2 and on-prem instances with Bamboo}
        ...
        \item{Ensure the quality and maintainability of software stack by leading code review and technical review}
